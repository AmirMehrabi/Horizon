        ...
        <form class="mt-8 space-y-5" action="{{ route('customer.register') }}" method="POST" id="registrationForm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="first_name" 
                               ...
                               type="text" 
                               required 
                               class="w-full px-4 py-3 border border-gray-300 bg-white rounded-lg text-base text-gray-900 placeholder-gray-400 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all @error('first_name') border-red-400 bg-red-50 @enderror" 
                    ...
                    <div>
                        ...
                        <input id="last_name" 
                               ...
                               type="text" 
                               required 
                               class="w-full px-4 py-3 border border-gray-300 bg-white rounded-lg text-base text-gray-900 placeholder-gray-400 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all @error('last_name') border-red-400 bg-red-50 @enderror" 
                ...
                <div>
                    ...
                    <input id="company_name" 
                           name="company_name" 
                           type="text" 
                           class="w-full px-4 py-3 border border-gray-300 bg-white rounded-lg text-base text-gray-900 placeholder-gray-400 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all @error('company_name') border-red-400 bg-red-50 @enderror" 
