            ...
            <form class="mt-8 space-y-6" action="{{ route('customer.verify-login') }}" method="POST" id="verifyForm">
                ...
                <div>
                    ...
                    <input id="code" 
                           ...
                           pattern="[0-9]{6}"
                           required 
                           class="w-full px-4 py-3.5 border border-gray-200 bg-white rounded-lg text-center text-2xl tracking-[0.5em] font-semibold text-gray-900 placeholder-gray-300 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-all" 
                           placeholder="000000"
