...
@section('header_content')
    <nav class="flex items-center space-x-2 {{ $isRtl ? 'space-x-reverse' : '' }}" aria-label="Breadcrumb">
        <!-- Dashboard -->
        <a href="{{ route('customer.dashboard') }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 group">
        ...
        <!-- Servers -->
        <a href="{{ route('customer.servers.index') }}" class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 group">
            <svg class="w-4 h-4 {{ $isRtl ? 'ml-1.5' : 'mr-1.5' }} text-gray-500 group-hover:text-gray-700 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
