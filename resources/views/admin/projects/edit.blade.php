...
<nav class="mb-6 flex items-center space-x-2 text-sm text-gray-500">
    ...
    <a href="{{ route('admin.projects.show', $project->id) }}" class="hover:text-gray-700">{{ $project->name }}</a>
    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
    </svg>
    <span class="text-gray-900">ویرایش</span>
</nav>

<!-- Header -->
<div class="mb-6 md:mb-8">
    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">ویرایش پروژه</h1>
    <p class="mt-1 text-sm text-gray-500">ویرایش اطلاعات پروژه {{ $project->name }}</p>
</div>
...
<form action="{{ route('admin.projects.update', $project->id) }}" method="POST" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
        ...
        <div>
            ...
            <input 
                ...
                name="region" 
                id="region" 
                value="{{ old('region', $project->region) }}"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <!-- Status -->
        <div>
            <label for="status" class="block text-sm font-medium text-gray-700 mb-2">وضعیت <span class="text-red-500">*</span></label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input 
                    ...
                    id="quota_instances" 
                    value="{{ old('quota_instances', $project->quota->instances ?? 20) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    name="quota_cores" 
                    id="quota_cores" 
                    value="{{ old('quota_cores', $project->quota->cores ?? 100) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    name="quota_ram" 
                    id="quota_ram" 
                    value="{{ old('quota_ram', $project->quota->ram ?? 204800) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            ...
            <div>
                ...
                <input 
                    ...
                    id="quota_gigabytes" 
                    value="{{ old('quota_gigabytes', $project->quota->gigabytes ?? 2048) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    value="{{ old('quota_floating_ips', $project->quota->floating_ips ?? 50) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    name="quota_networks" 
                    id="quota_networks" 
                    value="{{ old('quota_networks', $project->quota->networks ?? 10) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    name="quota_routers" 
                    id="quota_routers" 
                    value="{{ old('quota_routers', $project->quota->routers ?? 5) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
            <div>
                ...
                <input 
                    ...
                    name="quota_volumes" 
                    id="quota_volumes" 
                    value="{{ old('quota_volumes', $project->quota->volumes ?? 50) }}"
                    min="1"
                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            </div>
    ...
    <div class="flex flex-col sm:flex-row gap-3 sm:justify-end">
        <a href="{{ route('admin.projects.show', $project->id) }}" class="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 text-center">
            انصراف
        </a>
